import { NEFT_NAVY, PLOT_FONT } from "./brand";
...
/** Categorical palette for stacked breakdowns, anchored on the brand colours. */
export const CATEGORY_COLORS = [
  "#002147", "#FFC000", "#2E7D32", "#6A1B9A", "#00796B",
  "#C62828", "#1565C0", "#EF6C00", "#4E342E", "#455A64",
];
